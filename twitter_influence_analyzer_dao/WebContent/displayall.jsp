<%@page import="com.sampleapp.db.Influencer"%>
...
<!-- Modal -->
  ...
  <div style="background-color:white">
  	...
  	<tbody>
		<%
		java.util.List<Influencer> records  = (java.util.List<Influencer>) request.getAttribute("records");
		for (com.sampleapp.db.Influencer record : records) {
			String twitname = record.getTwitterHandle();
			int mcount = record.getMcount();
			int fcount = record.getFcount();
			int fscore = record.getFscore();
			int rtcount = record.getRtcount();
			int rtscore = record.getRtscore();
